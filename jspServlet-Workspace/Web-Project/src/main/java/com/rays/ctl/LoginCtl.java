...
public class LoginCtl extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (op != null) {
			...
			session.invalidate();
			request.setAttribute("succMsg", "user logout successfully");
		}

		RequestDispatcher rd = request.getRequestDispatcher("LoginView.jsp");
		// here RequestDispatcher is interface we use getRequestDispatcher() method of
		// HttpServletRequest class which return object of RequestDispatcher
